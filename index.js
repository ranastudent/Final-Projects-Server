...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.kt8jb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
      ...
      try {
            ...
            app.post('/payments', async (req, res) => {
                ...
                const deleteResult = await cartCollection.deleteMany(query)
                  res.send({paymentResult, deleteResult}); // Ensure this response is sent correctly
                });
